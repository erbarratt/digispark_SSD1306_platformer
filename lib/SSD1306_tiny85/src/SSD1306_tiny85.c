...
const unsigned char digital_font5x7[] =
{
	...
	void OLED_printChar( unsigned char ch ){
		...
		*/
		...
		OLED_addToUSIBuffer(digital_font5x7[(ch*5) - 156]);
		OLED_addToUSIBuffer(digital_font5x7[(ch*5) - 156 + 1]);
		OLED_addToUSIBuffer(digital_font5x7[(ch*5) - 156 + 2]);
		OLED_addToUSIBuffer(digital_font5x7[(ch*5) - 156 + 3]);
		OLED_addToUSIBuffer(digital_font5x7[(ch*5) - 156 + 4]);
		OLED_addToUSIBuffer(0x00);
		OLED_addToUSIBuffer(0x00);
		OLED_xmitBuffer(1);
